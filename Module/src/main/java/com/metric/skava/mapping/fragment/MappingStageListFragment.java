package com.metric.skava.mapping.fragment;
...
import com.metric.skava.mapping.adapter.MappingStageArrayAdapter;
 ...
 */
public class MappingStageListFragment extends ListFragment {
    ...
    private MappingStageArrayAdapter mStageArrayAdapter;
     ...
     */
    public MappingStageListFragment() {
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        MappingStageDataProvider dataProvider = MappingStageDataProvider.getInstance(getActivity());
        List<MappingStage> listStages = dataProvider.getAllStages();
        mStageArrayAdapter = new MappingStageArrayAdapter(
                getActivity(),
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        MappingStage selectedStage = mStageArrayAdapter.getItem(position);
