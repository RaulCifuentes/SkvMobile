...
public class ParseComServerAuthenticate implements ServerAuthenticate{
    ...
    public String userSignUp(String name, String email, String pass, String authType) throws Exception {
        ...
        httpPost.addHeader("X-Parse-Application-Id","RL7ORe0kIjZREt3Zf3n4XdgnR1GzG4fXGIqaxNT6");
        httpPost.addHeader("X-Parse-REST-API-Key", "Lz76meHFIAatA5VSxnhiIRLhrVy0pBDmy1P6JIK5");
...
//        String user = "{\"username\":\"" + email + "\",\"password\":\"" + pass + "\",\"phone\":\"415-392-0202\"}";
    ...
    public String userSignIn(String user, String pass, String authType) throws Exception {
        ...
        httpGet.addHeader("X-Parse-Application-Id","RL7ORe0kIjZREt3Zf3n4XdgnR1GzG4fXGIqaxNT6");
        httpGet.addHeader("X-Parse-REST-API-Key", "Lz76meHFIAatA5VSxnhiIRLhrVy0pBDmy1P6JIK5");
