...
//
//                Log.d(SkavaConstants.LOG, TAG + "> Started authenticating");
//
...
//        Log.d(SkavaConstants.LOG, TAG + "> finishLogin");
//
...
//            Log.d(SkavaConstants.LOG, TAG + "> finishLogin > addAccountExplicitly");
...
//        } else {
//            Log.d(SkavaConstants.LOG, TAG + "> finishLogin > setPassword");
