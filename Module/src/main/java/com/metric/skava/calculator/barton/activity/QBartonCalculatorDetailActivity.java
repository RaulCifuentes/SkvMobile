package com.metric.skava.calculator.barton.activity;
 ...
 */
public class QBartonCalculatorDetailActivity extends SkavaFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(QBartonCalculatorMainFragment.ARG_BASKET_ID,
                    getIntent().getStringExtra(QBartonCalculatorMainFragment.ARG_BASKET_ID));
