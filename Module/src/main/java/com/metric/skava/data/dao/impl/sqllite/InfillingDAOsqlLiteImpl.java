 ...
 */
public class InfillingDAOsqlLiteImpl extends SqlLiteBaseDAO implements LocalInfillingDAO {
    ...
    protected List<Infilling> assambleInfillings(Cursor cursor) throws DAOException {
    ...
    @Override
    public void saveInfilling(Infilling assessment) throws DAOException {
