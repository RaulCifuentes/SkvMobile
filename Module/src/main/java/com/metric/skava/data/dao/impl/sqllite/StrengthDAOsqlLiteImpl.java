...
public class StrengthDAOsqlLiteImpl extends SqlLiteBaseDAO implements LocalStrengthDAO {
    ...
    public StrengthDAOsqlLiteImpl(Context context) throws DAOException {
        super(context);
        mContext = context;
    ...
    public StrengthOfRock getStrength(String indexCode, String groupCode, String code) throws DAOException {
        String[] names = new String[]{StrengthTable.INDEX_CODE_COLUMN, GROUP_CODE_COLUMN, CODE_COLUMN};
    ...
    public List<StrengthOfRock> getAllStrengths() throws DAOException {
        Cursor cursor = getAllRecords(StrengthTable.MAPPED_INDEX_DATABASE_TABLE);
        List<StrengthOfRock> list = assambleStrengths(cursor);
        cursor.close();
        return list;
    }
