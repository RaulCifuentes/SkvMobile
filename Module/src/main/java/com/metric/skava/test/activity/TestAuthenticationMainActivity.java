...
import com.metric.skava.authentication.AccountGeneral;

public class TestAuthenticationMainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_authentication_main);
        ...
        final AccountManagerFuture<Bundle> future = mAccountManager.addAccount(accountType, authTokenType, null, null, this, new AccountManagerCallback<Bundle>() {
            ...
            public void run(AccountManagerFuture<Bundle> future) {
                try {
                    ...
                    Log.d(SkavaConstants.LOG, "AddNewAccount Bundle is " + bnd);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Log.d(SkavaConstants.LOG, "GetToken Bundle is " + bnd);
                } catch (Exception e) {
                    e.printStackTrace();
                    showMessage(e.getMessage());
                }
                ...
                new AccountManagerCallback<Bundle>() {
                    ...
                    public void run(AccountManagerFuture<Bundle> future) {
                        ...
                        try {
                            ...
                            final String authtoken = bnd.getString(AccountManager.KEY_AUTHTOKEN);
                            showMessage(((authtoken != null) ? "SUCCESS!\ntoken: " + authtoken : "FAIL"));
                            Log.d(SkavaConstants.LOG, "GetTokenForAccount Bundle is " + bnd);
