 ...
 */
public class AssessmentReportMainFragment extends SkavaFragment {

    public static final String ARG_BASKET_ID = "PARCELABLE_DATA_BASKET_ID";

    public AssessmentReportMainFragment() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {

        View rootView = inflater.inflate(R.layout.assessment_report_main_fragment, container, false);
        ...
        if (qCalculation.getIsIntersection() != null && qCalculation.getIsIntersection().booleanValue()){
