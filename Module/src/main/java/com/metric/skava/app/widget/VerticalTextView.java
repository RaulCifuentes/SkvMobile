...
public class VerticalTextView extends TextView {
    ...
    public VerticalTextView(Context context, AttributeSet attrs) {
        ...
        setTextColor(a.getColor(R.styleable.VerticalTextView_textColor, 0xFF000000));

        int textSize = a.getDimensionPixelOffset(R.styleable.VerticalTextView_textSize, 0);
